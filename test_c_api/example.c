...
int main(int argc, char* argv[])
{
	...
	clogger* console = cspd_stdout_logger_mt("console");
        ...
        //
        clogger* file_logger = cspd_rotating_logger_mt("file_logger", "logs/mylogfile", 1048576 * 5, 3, false);
        for ( i = 0; i < 10; ++i)
        ...
        //
        clogger* daily_logger = cspd_daily_logger_mt("daily_logger", "logs/daily", 2, 30, false);
	...
	cspd_info(get_console, "loggers can be retrieved from a global registry using the cspd_get(logger_name) function");
        //
        ...
        clogger* async_file = cspd_daily_logger_st("async_file_logger", "logs/async_log.txt", 0, 0 ,false);
        for ( i = 0; i < 100; ++i)
        ...
        cspd_warn(syslog_logger, "This is warning that will end up in syslog. This is Linux only!");
#endif
